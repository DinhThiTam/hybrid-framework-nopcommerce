...
public class ShoppingCartUI {
	...
	public static final String ROW_VALUE_BY_SKU_PRODUCT_PRICE_QTY_TOTAL = "//td[contains(string(),'%s')]/following-sibling::td[contains(string(),'%s')]/following-sibling::td[contains(string(),'%s')]/following-sibling::td[contains(string(),'%s')]/following-sibling::td[@class='remove-from-cart']";
