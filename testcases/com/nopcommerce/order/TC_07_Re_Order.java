...
//		verifyEquals(checkoutPage.getInfoListByTitleAndClass(driver, "Billing Address","name"),EditAddress.EDIT_FULLNAME);
//		verifyEquals(checkoutPage.getInfoListByTitleAndClass(driver,"Billing Address","email"),"Email: " + emailAddress);
//		verifyEquals(checkoutPage.getInfoListByTitleAndClass(driver,"Billing Address","phone"),"Phone: " + UpdateAddress.UPDATE_PHONE_NUMBER);
//		verifyEquals(checkoutPage.getInfoListByTitleAndClass(driver,"Billing Address","fax"),"Fax:");
//		verifyEquals(checkoutPage.getInfoListByTitleAndClass(driver,"Billing Address","address1"),UpdateAddress.UPDATE_ADDRESS1);
//		verifyEquals(checkoutPage.getInfoListByTitleAndClass(driver,"Billing Address","city-state-zip"),UpdateAddress.UPDATE_CITY_ZIP_CODE);
//		verifyEquals(checkoutPage.getInfoListByTitleAndClass(driver,"Billing Address","country"),UpdateAddress.UPDATE_COUNTRY_NAME);
//		
//		verifyEquals(checkoutPage.getInfoListByTitleAndClass(driver,"Payment","payment-method"),"Payment Method: Credit Card");
//		
//		verifyEquals(checkoutPage.getInfoListByTitleAndClass(driver,"Shipping Address","name"),EditAddress.EDIT_FULLNAME);
//		verifyEquals(checkoutPage.getInfoListByTitleAndClass(driver,"Shipping Address","email"),"Email: " + emailAddress);
//		verifyEquals(checkoutPage.getInfoListByTitleAndClass(driver,"Shipping Address","phone"),"Phone: " + UpdateAddress.UPDATE_PHONE_NUMBER);
//		verifyEquals(checkoutPage.getInfoListByTitleAndClass(driver,"Shipping Address","fax"),"Fax:");
//		verifyEquals(checkoutPage.getInfoListByTitleAndClass(driver,"Shipping Address","address1"),UpdateAddress.UPDATE_ADDRESS1);
//		verifyEquals(checkoutPage.getInfoListByTitleAndClass(driver,"Shipping Address","city-state-zip"),UpdateAddress.UPDATE_CITY_ZIP_CODE);
//		verifyEquals(checkoutPage.getInfoListByTitleAndClass(driver,"Shipping Address","country"),UpdateAddress.UPDATE_COUNTRY_NAME);
//		
//		verifyEquals(checkoutPage.getInfoListByTitleAndClass(driver,"Shipping","shipping-method"),"Shipping Method: Next Day Air");
//		
//		
