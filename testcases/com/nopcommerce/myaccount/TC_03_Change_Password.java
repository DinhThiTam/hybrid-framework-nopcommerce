...
public class TC_03_Change_Password extends BaseTest {
	...
	public void My_Account_01_Customer_Info() {
		...
		log.info("My_Account_01 - Step 02: Open 'Change password' form");
		myAccountPage.openTabMenuByName("Change password");
		
		log.info("My_Account_01 - Step 03: Enter Old Password information to textbox");
		myAccountPage.enterToTextboxByID(driver, "OldPassword", password);
		
		log.info("My_Account_01 - Step 03: Update New Password information to textbox");
		myAccountPage.enterToTextboxByID(driver, "NewPassword", newPassword);
		
		log.info("My_Account_01 - Step 03: Update Confirm New Password information to textbox");
		myAccountPage.enterToTextboxByID(driver, "ConfirmNewPassword", newPassword);
		
		log.info("My_Account_01 - Step 03: Click to 'Change Password' button");
		myAccountPage.clickToButtonByName(driver, "Change password");
		
		log.info("My_Account_01 - Step 03: Verify success message is displayed");
		verifyTrue(myAccountPage.isChangePasswordSuccessMessageDisplayed());
		
		log.info("My_Account_01 - Step 03: Click to 'x' icon");
		myAccountPage.clickToCloseMessageButton();
		myAccountPage.sleepInsecond(3);
		
		log.info("Pre-Condition - Step 08: Click to 'Log out' button");
		myAccountPage.openMenuHeaderPageByClass(driver, "ico-logout");
		homePage = PageGenerator.getHomePage(driver);
		
		log.info("Pre-Condition - Step 08: Click to 'Log in' button");
		homePage.openMenuHeaderPageByClass(driver, "ico-login");
		loginPage = PageGenerator.getLoginPage(driver);
		
		log.info("Login_01 - Step 01: Enter email address to 'Email' textbox");
		loginPage.enterToTextboxByID(driver,"Email", emailAddress);
		
		log.info("Login_01 - Step 02: Enter old password to 'Password' textbox");
		...
		log.info("Login_01 - Step 02: Enter new password to 'Password' textbox");
		...
		log.info("Login_01 - Step 04: Verify login success");
